...
public class KDLBoolean extends KDLValue<Boolean> {
    ...
    public KDLString getAsString() {
        return value
            ? new KDLString("true", type)
            : new KDLString("false", type);
    }
    ...
    @Override
    protected void writeKDLValue(Writer writer, PrintConfig printConfig)
        throws IOException {
    ...
    public static Optional<KDLBoolean> fromString(
        String str,
    ...
    public String toString() {
        return "KDLBoolean{" + "value=" + value + ", type=" + type + '}';
    }
