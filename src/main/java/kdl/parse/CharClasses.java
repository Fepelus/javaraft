...
/**
 * Various functions used during parsing and printing to check character
 * membership in various character classes.
 * <p>
 * Also contains functions for transforming characters into their escape
 * sequences.
 */
public class CharClasses {
    ...
    /**
     * Check if the character is valid in a bare identifier after the first
     * character
     *
     * @param c the character to check
     * @return true if the character is valid, false otherwise
    ...
    /**
     * Check if the character is contained in one of the three literal values: true,
     * false, and null
     *
     * @param c the character to check
     ...
     *
     * @param c the character to check
     * @return An Optional wrapping the escape sequence string if the character
     *         needs to be escaped, or false otherwise
     */
