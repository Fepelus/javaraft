...
public class KDLParserFacade extends KDLParser {
    ...
    @Override
    public KDLDocument parseDocument(KDLParseContext context, boolean root)
        throws IOException {
        return super.parseDocument(context, root);
    }

    @Override
    public Optional<KDLNode> parseNode(KDLParseContext context)
        throws IOException {
    ...
    @Override
    public KDLObject parseArgOrProp(KDLParseContext context)
        throws IOException {
    ...
    @Override
    public KDLNumber parseNonDecimalNumber(
        KDLParseContext context,
        ...
        return super.parseNonDecimalNumber(
            context,
            legalChars,
            sign,
            radix,
    ...
    @Override
    public KDLNumber parseDecimalNumber(
        KDLParseContext context,
        char sign,
        Optional<String> type
    ) throws IOException {
    ...
    @Override
    public String parseBareIdentifier(KDLParseContext context)
        throws IOException {
        return super.parseBareIdentifier(context);
    }

    @Override
    public String parseEscapedString(KDLParseContext context)
        throws IOException {
    ...
    @Override
    public SlashAction getSlashAction(KDLParseContext context, boolean escaped)
        throws IOException {
    ...
    @Override
    public WhitespaceResult consumeWhitespaceAndBlockComments(
        KDLParseContext context
    ) throws IOException {
    ...
    @Override
    public void consumeBlockComment(KDLParseContext context)
        throws IOException {
        super.consumeBlockComment(context);
    }

    @Override
    public WhitespaceResult consumeWhitespaceAndLinespace(
        KDLParseContext context
    ) throws IOException {
